...
if __name__ == '__main__':
    ...
    for i in range(0,4):
        ...
        X_MRI, y_MRI, pred_MRI = MLP.construct_automatically(n_input_MRI,[n_hidden_MRI_1,n_hidden_MRI_2, n_hidden_MRI_3],dropout=dropout)
        ...
        x_COMB, y_COMB, pred_COMB = MLP.construct_automatically(300 + 300,[400,2], X=conc)
